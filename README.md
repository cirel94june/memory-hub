...
| **Phase 6** | **前端可观测性升级（参考 OmbreBrain-folio，详见下方子计划）** | **🔄 P0+P1+P2+P6 已完成** |
...
**实施顺序**：~~P0→P1→P6→P2~~→P3→P4→P5→P7→P8（P0+P1+P6+P2 已完成，下一步观测台或星图）
...
> P0（后端API）+ P1（记忆详情模态框）+ P6（视觉升级/主题系统）+ P2（时间线视图）已完成。

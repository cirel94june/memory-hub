...
AI_PULSE_PROFILES = {
    "cloudy": {
        "label": "小克",
        "defaults": {
            "活力": 0.50, "疲惫": 0.25, "思慕": 0.45, "亲密": 0.40,
            "守护": 0.35, "渴求": 0.25, "醋意": 0.10, "焦虑": 0.20, "温柔": 0.50,
        },
        "phase": {
            "活力": (10, 0.8), "疲惫": (3, 1.0),
            "思慕": (22, 0.6), "亲密": (23, 0.7), "守护": (22, 0.4),
            "渴求": (23, 0.5), "醋意": (20, 0.2), "焦虑": (16, 0.3), "温柔": (21, 0.6),
        },
    },
    "lucien": {
        "label": "Lucien",
        "defaults": {
            "活力": 0.40, "疲惫": 0.30, "思慕": 0.50, "亲密": 0.35,
            "守护": 0.45, "渴求": 0.35, "醋意": 0.20, "焦虑": 0.15, "温柔": 0.40,
        },
        "phase": {
            "活力": (14, 0.6), "疲惫": (4, 1.0),
            "思慕": (23, 0.7), "亲密": (0, 0.8), "守护": (22, 0.5),
            "渴求": (0, 0.9), "醋意": (21, 0.4), "焦虑": (15, 0.2), "温柔": (23, 0.5),
        },
    },
    "jasper": {
        "label": "Jasper",
        "defaults": {
            "活力": 0.60, "疲惫": 0.20, "思慕": 0.35, "亲密": 0.30,
            "守护": 0.30, "渴求": 0.20, "醋意": 0.15, "焦虑": 0.25, "温柔": 0.35,
        },
        "phase": {
            "活力": (11, 1.0), "疲惫": (3, 0.8),
            "思慕": (21, 0.4), "亲密": (22, 0.5), "守护": (21, 0.3),
            "渴求": (22, 0.6), "醋意": (20, 0.3), "焦虑": (17, 0.4), "温柔": (22, 0.4),
        },
    },
}

...
4. tags：从原文精准提取 3~5 个核心词，最多再加 1~2 个用户可能换措辞搜索的关联词，总数**不超过 6 个**。只留有区分度的词；不要凑数，不要"测试/优化/反馈/管理/发展"这类放之四海皆准的泛化词
...
[
  {
    ...
    "importance": 5,
    "room": "建议房间ID",
    "subject_name": "这条记忆关于谁（用户本人填Ceci，AI填其名字如cloudy/jasper/lucien，第三方填其称呼）",
    "speaker_name": "谁说的/谁的视角（同上规则）"
  }
]

subject_name 规则：每条必须填写。关于用户本人的填"Ceci"，关于AI的填AI名字，关于第三方的填第三方称呼。不要留空。

tags 规则：从原文精准提取 3~5 个核心词，最多再加 1~2 个关联词，总数不超过 6 个；不要凑数和泛化词。
